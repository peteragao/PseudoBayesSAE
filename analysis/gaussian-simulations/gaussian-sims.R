...
out_res_dir <- "results/gaussian-simulations/"
dir.create(file.path(out_res_dir), showWarnings = FALSE)
sim_res_dir <- "analysis/gaussian-simulations/"
...
run_simulation <- function(formula, 
  ...
  Bayes_fit <-
    svymap::fit_psbayes(formula, 
                        ...
                        rescale = F)
  Bayes_est<-
    svymap::get_psbayes_area_mean_gaussian(formula, 
...
cov_dat_path <- "analysis/gaussian-simulations/gaussian-sims-cov-dat.rds"
